...
import com.test.jooq.tables.Books.BooksPath;
import com.test.jooq.tables.records.AuthorsRecord;
...
public class Authors extends TableImpl<AuthorsRecord> {
    ...
    /**
     * The column <code>public.authors.birthdate</code>.
     */
    public final TableField<AuthorsRecord, LocalDate> BIRTHDATE = createField(DSL.name("birthdate"), SQLDataType.LOCALDATE.nullable(false), this, "");

    /**
     * The column <code>public.authors.nationality</code>.
     */
    public final TableField<AuthorsRecord, String> NATIONALITY = createField(DSL.name("nationality"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>public.authors.created_at</code>.
     */
    public final TableField<AuthorsRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.authors.updated_at</code>.
     */
    public final TableField<AuthorsRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.authors.deleted_at</code>.
     */
    public final TableField<AuthorsRecord, LocalDateTime> DELETED_AT = createField(DSL.name("deleted_at"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super LocalDate, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super String, ? super LocalDate, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
